...
return new class extends Migration
{
    ...
    {
        Schema::create('technologies_sections', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('background_image')->nullable(); // صورة القسم
    ...
    {
        Schema::dropIfExists('technologies_sections');
    }
};
