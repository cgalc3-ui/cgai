            ...
            <form method="GET" action="{{ route('tickets.index') }}" class="filter-form">
                <div class="filter-inputs">
                    <div class="filter-group">
                        <label for="status"><i class="fas fa-tasks"></i> {{ __('messages.status_label') }}:</label>
                    ...
                    <div class="filter-group">
                        <label for="priority"><i class="fas fa-exclamation-circle"></i> {{ __('messages.priority_label') }}:</label>
