...
@section('title', __('messages.add_help_guide'))
@section('page-title', __('messages.add_help_guide'))

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>{{ __('messages.add_help_guide') }}</h2>
            <p>{{ __('messages.create_help_guide_desc') }}</p>
        </div>
    ...
    <div class="form-container">
        <form action="{{ route('admin.help-guides.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="content_en" name="content_en" rows="6" class="form-control">{{ old('content_en') }}</textarea>
                @error('content_en')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
