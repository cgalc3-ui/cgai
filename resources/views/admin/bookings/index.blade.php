    ...
    <form method="GET" action="{{ route('admin.bookings') }}" class="filter-form">
        <div class="filter-inputs">
            ...
            <div class="filter-group">
                ...
                <input type="text" name="search" id="search" class="filter-input" placeholder="اسم العميل أو الهاتف" value="{{ request('search') }}">
            </div>
        </div>
                        ...
                        <div class="service-info">
                            ...
                            @if($booking->serviceDuration)
                                <div class="service-duration">
                                    <i class="fas fa-clock"></i> {{ $booking->serviceDuration->formatted_duration }}
                                </div>
                            @endif
                        </div>
                    </td>
