                        ...
                        <td>
                            <div style="display: flex; gap: 8px;">
                                ...
                                <form action="{{ route('admin.service-durations.destroy', $duration) }}" method="POST"
                                    class="d-inline" onsubmit="event.preventDefault(); Confirm.delete({{ json_encode(__('messages.delete_service_duration_confirm')) }}, {{ json_encode(__('messages.confirm_delete_title')) }}).then(confirmed => { if(confirmed) this.submit(); }); return false;">
                                    @csrf
                                    @method('DELETE')
