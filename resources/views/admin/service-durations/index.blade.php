                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.service-durations.edit', $duration) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i> تعديل
                            </a>
                            <form action="{{ route('admin.service-durations.destroy', $duration) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه المدة؟')">
                                @csrf
                                @method('DELETE')
