...
<form action="{{ route('admin.ready-apps.apps.store') }}" method="POST" enctype="multipart/form-data" class="modal-form"
    id="createReadyAppForm">
    @csrf
    ...
    <div class="form-actions">
        ...
        <button type="button" class="btn btn-secondary" onclick="closeModal('createReadyAppModal'); return false;">
...
<script>
    (function () {
        console.log("Ready Apps Create Modal Script Initialized");
