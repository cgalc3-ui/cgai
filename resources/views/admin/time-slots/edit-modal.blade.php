<form action="{{ route('admin.time-slots.update', $timeSlot) }}" method="POST" id="timeSlotEditForm" class="modal-form">
    @csrf
    @method('PUT')
    ...
    <div class="form-actions">
        ...
        <button type="button" class="btn btn-secondary" onclick="closeModal('editTimeSlotModal'); return false;">
