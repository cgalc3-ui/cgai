                        ...
                        <td>
                            <div style="display: flex; gap: 8px;">
                                ...
                                <form action="{{ route('admin.specializations.delete', $specialization) }}" method="POST"
                                    class="d-inline" onsubmit="event.preventDefault(); Confirm.delete({{ json_encode(__('messages.delete_specialization_confirm')) }}, {{ json_encode(__('messages.confirm_delete_title')) }}).then(confirmed => { if(confirmed) this.submit(); }); return false;">
                                    @csrf
                                    @method('DELETE')
