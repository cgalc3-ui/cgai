    ...
    <form method="GET" action="{{ route('admin.specializations') }}" class="filter-form">
        <div class="filter-inputs">
            <div class="filter-group">
                ...
                <input type="text" name="search" id="search" value="{{ $searchQuery }}" placeholder="ابحث بالاسم أو الوصف" class="filter-input">
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <form action="{{ route('admin.specializations.delete', $specialization) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا التخصص؟')">
                                @csrf
                                @method('DELETE')
