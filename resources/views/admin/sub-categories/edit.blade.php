...
@section('title', __('messages.edit_sub_category'))
@section('page-title', __('messages.edit_sub_category'))

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>{{ __('messages.edit_sub_category') }}</h2>
            <p>{{ __('messages.edit_sub_category_desc') }}</p>
        </div>
