<form action="{{ route('admin.faqs.store') }}" method="POST" id="faqCreateForm" class="modal-form">
    @csrf
    ...
    <div class="form-group">
        ...
        <select id="role" name="role" class="form-control" required>
            <option value="customer" {{ old('role', 'customer') == 'customer' ? 'selected' : '' }}>{{ __('messages.customer_role') }}</option>
            <option value="staff" {{ old('role') == 'staff' ? 'selected' : '' }}>{{ __('messages.staff_role') }}</option>
            <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>{{ __('messages.admin_role') }}</option>
        </select>
        @error('role')
            <span class="error-message">{{ $message }}</span>
        @enderror
    ...
    <div class="form-group">
        ...
        <select id="category" name="category" class="form-control" required>
            <option value="general" {{ old('category') == 'general' ? 'selected' : '' }}>{{ __('messages.general') }}</option>
            <option value="account" {{ old('category') == 'account' ? 'selected' : '' }}>{{ __('messages.account') }}</option>
            <option value="services" {{ old('category') == 'services' ? 'selected' : '' }}>{{ __('messages.services') }}</option>
            <option value="payment" {{ old('category') == 'payment' ? 'selected' : '' }}>{{ __('messages.payment') }}</option>
    ...
    <div class="form-actions">
        ...
        <button type="button" class="btn btn-secondary" onclick="closeModal('createFaqModal'); return false;">
