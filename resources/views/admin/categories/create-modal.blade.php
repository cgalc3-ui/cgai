<form action="{{ route('admin.categories.store') }}" method="POST" id="categoryCreateForm" class="modal-form" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <textarea id="description" name="description" class="form-control" rows="4" placeholder="أدخل وصف الفئة بالعربية">{{ old('description') }}</textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea id="description_en" name="description_en" class="form-control" rows="4"
            style="direction: ltr; text-align: left;" placeholder="Enter category description in English">{{ old('description_en') }}</textarea>
    </div>
