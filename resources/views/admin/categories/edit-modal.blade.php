<form action="{{ route('admin.categories.update', $category) }}" method="POST" id="categoryEditForm" class="modal-form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
...
<style>
    ...
    [data-theme="dark"] .form-group img {
        border-color: rgba(255, 255, 255, 0.1) !important;
    }
</style>
