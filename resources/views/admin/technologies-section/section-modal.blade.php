<form action="{{ isset($section) ? route('admin.customer-facing.technologies-section.update', $section) : route('admin.customer-facing.technologies-section.store') }}" method="POST" id="sectionForm" class="modal-form" enctype="multipart/form-data">
    @csrf
    @if(isset($section))
        @method('PUT')
    @endif
