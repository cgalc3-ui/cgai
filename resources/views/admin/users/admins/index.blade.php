                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <button type="button" class="btn btn-sm btn-warning" onclick="openEditAdminModal({{ $user->id }}, '{{ $user->name }}', '{{ $user->email }}', '{{ $user->phone }}')">
                                <i class="fas fa-edit"></i> تعديل
                            </button>
                            <form action="{{ route('admin.users.admins.delete', $user) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا الأدمن؟')">
                                @csrf
                                @method('DELETE')
