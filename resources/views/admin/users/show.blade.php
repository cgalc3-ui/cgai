...
<div class="page-header">
    <div class="page-header-left">
        <h2>{{ $user->name }}</h2>
        <p>عرض وتعديل معلومات المستخدم</p>
    </div>
    ...
    @if($user->isStaff() && $user->employee)
        <div class="card">
            ...
            <div class="card-body">
                <div class="info-grid">
                    <div class="info-item">
                        <span class="info-label">التخصصات:</span>
                        <span class="info-value">
                    ...
                    <div class="info-item">
                        <span class="info-label">السعر/ساعة:</span>
                        <span class="info-value">
                            @if($user->employee->hourly_rate)
                                {{ number_format($user->employee->hourly_rate, 2) }} ريال
                            @else
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    هذا المستخدم من نوع Staff لكنه غير مرتبط كموظف. يمكنك إنشاء سجل موظف له من قسم الأوقات المتاحة.
                </div>
            </div>
        </div>
    @endif
