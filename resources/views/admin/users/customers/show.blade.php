        ...
        <div class="card-body">
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">{{ $user->date_of_birth ? $user->date_of_birth->format('Y-m-d') : '-' }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">النوع:</span>
                    <span class="info-value">{{ $user->gender ? ($user->gender == 'male' ? 'ذكر' : 'أنثى') : '-' }}</span>
                </div>
                <div class="info-item">
