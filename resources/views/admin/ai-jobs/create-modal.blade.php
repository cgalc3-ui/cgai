<form id="createAiJobForm" method="POST" action="{{ route('admin.ai-jobs.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" name="company_en" id="company_en" class="form-control" value="{{ old('company_en') }}">
        @error('company_en')
            <span class="error-message">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="location_en" id="location_en" class="form-control" value="{{ old('location_en') }}">
        @error('location_en')
            <span class="error-message">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="salary_range" id="salary_range" class="form-control" value="{{ old('salary_range') }}" placeholder="{{ __('messages.salary_range_example') }}">
        @error('salary_range')
            <span class="error-message">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <select name="job_type" id="job_type" class="form-control" required>
            <option value="full_time" {{ old('job_type') === 'full_time' ? 'selected' : '' }}>{{ __('messages.full_time') }}</option>
            <option value="part_time" {{ old('job_type') === 'part_time' ? 'selected' : '' }}>{{ __('messages.part_time') }}</option>
            <option value="contract" {{ old('job_type') === 'contract' ? 'selected' : '' }}>{{ __('messages.contract') }}</option>
            <option value="freelance" {{ old('job_type') === 'freelance' ? 'selected' : '' }}>{{ __('messages.freelance') }}</option>
            <option value="internship" {{ old('job_type') === 'internship' ? 'selected' : '' }}>{{ __('messages.internship') }}</option>
        </select>
        @error('job_type')
            <span class="error-message">{{ $message }}</span>
        @enderror
    ...
    <div class="form-group">
        ...
        <textarea name="requirements_en" id="requirements_en" class="form-control" rows="5">{{ old('requirements_en') }}</textarea>
    ...
    <div class="form-group">
        ...
        <textarea name="benefits" id="benefits" class="form-control" rows="5">{{ old('benefits') }}</textarea>
        @error('benefits')
            <span class="error-message">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <textarea name="benefits_en" id="benefits_en" class="form-control" rows="5">{{ old('benefits_en') }}</textarea>
        @error('benefits_en')
            <span class="error-message">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="email" name="application_email" id="application_email" class="form-control" value="{{ old('application_email') }}">
    ...
    <div class="form-group">
        ...
        <input type="url" name="application_url" id="application_url" class="form-control" value="{{ old('application_url') }}">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="closeModal('createAiJobModal')">{{ __('messages.cancel') }}</button>
        <button type="submit" class="btn btn-primary">{{ __('messages.save') }}</button>
    </div>
</form>

<script>
    document.getElementById('createAiJobForm').addEventListener('submit', function(e) {
        e.preventDefault();
