...
@section('title', __('messages.add_subscription'))
@section('page-title', __('messages.add_subscription'))

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>{{ __('messages.add_subscription') }}</h2>
        ...
        <form action="{{ route('admin.subscriptions.store') }}" method="POST" id="subscriptionForm">
            ...
            <div class="form-group">
                ...
                <select id="duration_type" name="duration_type" class="form-control" required>
                    ...
                    <option value="3months" {{ old('duration_type') == '3months' ? 'selected' : '' }}>
                        {{ __('messages.3months') }}
                    </option>
                    <option value="6months" {{ old('duration_type') == '6months' ? 'selected' : '' }}>
                        {{ __('messages.6months') }}
                    </option>
