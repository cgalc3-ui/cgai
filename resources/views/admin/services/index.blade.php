                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <form action="{{ route('admin.services.destroy', $service) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه الخدمة؟ سيتم حذف جميع مدة الخدمات المرتبطة بها.')">
                                @csrf
                                @method('DELETE')
