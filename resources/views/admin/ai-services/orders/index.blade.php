...
@section('title', __('messages.ai_service_orders'))
@section('page-title', __('messages.ai_service_orders'))

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>{{ __('messages.ai_service_orders') }}</h2>
    ...
    <div class="filter-container" data-filter-title="{{ __('messages.filter_options') }}">
        <form method="GET" action="{{ route('admin.ai-services.orders.index') }}" class="filter-form">
            ...
            <div class="filter-actions" style="margin-inline-start: 20px;">
                ...
                <a href="{{ route('admin.ai-services.orders.index') }}" class="btn btn-secondary">
    ...
    <div class="table-container">
        <table class="data-table">
            <thead>
                <tr>
                    <th>{{ __('messages.ai_service_name') }}</th>
            ...
            <tbody>
                @forelse($orders as $order)
                    <tr>
                        <td>{{ $order->service->trans('name') }}</td>
                        <td>
                            <div>
                        ...
                        <td class="text-center">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <a href="{{ route('admin.ai-services.orders.show', $order) }}" class="calm-action-btn primary"
