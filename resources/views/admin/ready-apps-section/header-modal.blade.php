<form action="{{ isset($section) ? route('admin.customer-facing.ready-apps-section.update', $section) : route('admin.customer-facing.ready-apps-section.store') }}" method="POST" id="headerForm" class="modal-form">
    @csrf
    @if(isset($section))
        @method('PUT')
