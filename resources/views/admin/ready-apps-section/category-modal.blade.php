<form action="{{ route('admin.customer-facing.ready-apps-section.category.update', $category) }}" method="POST" id="categoryForm" class="modal-form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
